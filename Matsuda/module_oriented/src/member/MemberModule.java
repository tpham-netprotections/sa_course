...
public class MemberModule {
      ...
      public void printMemberData (Member member) {
        ...
        //メンバー登録機能
      public void MemberRegistration (List<Member> defaultList) {
      ...
      //サービス利用登録
      public void serviceStartStop (Member member, List<Member> mList) {
          ...
          Member member1 = mList.get(memberId);
          MemberModule m = new MemberModule();
          m.printMemberData(member1);
        ...
        //メンバー検索機能
      public void memberSearch (Member user, List<Member> mList) {
          ...
          if (mList.get(memberId) != null) {
              MemberModule m = new MemberModule();
              m.printMemberData(mList.get(memberId));
          } else {
       ...
       //メンバー編集機能
      public void memberEdit (Member user, List<Member> mList) {
          ...
          Member searchedMember = mList.get(editId);

          //編集の実行
          if (searchedMember != null) {
              MemberModule m = new MemberModule();
              m.printMemberData(searchedMember);
